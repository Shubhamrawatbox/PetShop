...
## Settings & Commands
All settings are now listed in the [Settings & Commands Docs](https://github.com/glenn2223/vscode-live-sass-compiler/blob/HEAD/./docs/settings.md).

## FAQ
*All FAQs are now listed in the [FAQ Docs](https://github.com/glenn2223/vscode-live-sass-compiler/blob/HEAD/./docs/faqs.md)*

## What's new ?
See the full changelog [here](https://github.com/glenn2223/vscode-live-sass-compiler/blob/HEAD/CHANGELOG.md).

## LICENSE
This extension is licensed under the [MIT License](https://github.com/glenn2223/vscode-live-sass-compiler/blob/HEAD/LICENSE)
